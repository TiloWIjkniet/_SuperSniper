...
public class ProningState_Player : BaseState_Player
{
    ...
    public override void UpdateState(Brains_Player brains)
    {
        ...
        brains.currentStamina +=  Time.deltaTime * 1f;
    ...
    public IEnumerator col(Brains_Player brains)
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            brains.image[0].color = Color.Lerp(brains.image[0].color, new Color (255,255,255,0), (float)i/5);
            yield return new WaitForSeconds(0.05f);
        }    

        brains.image[1].color =  new Color (255,255,255,0);
        brains.image[0].color =  new Color (255,255,255,0);  

        for (int i = 0; i < 5; i++)
        {
            brains.image[2].color = Color.Lerp(brains.image[2].color, new Color (255,255,255,0.355f), (float)i/5);
            yield return new WaitForSeconds(0.05f);
        }  

        brains.image[2].color =  new Color (255,255,255,0.355f);   
                  
    }

    public override void FixedUpdateState(Brains_Player brains)
    {
        HandelMovement(brains);
    ...
    public override void HandelJump(Brains_Player brains)
    {
        ...
        brains.stateMachine_Player.ChangeState(brains.stateMachine_Player.walkState_Player);
        brains.currentJumps ++;
    }
    ...
    void  HandelMovement(Brains_Player brains)
    {
