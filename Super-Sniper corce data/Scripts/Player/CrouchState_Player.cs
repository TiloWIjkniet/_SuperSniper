...
public class CrouchState_Player : BaseState_Player
{
    ...
    public IEnumerator col(Brains_Player brains)
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            brains.image[1].color = Color.Lerp(brains.image[1].color, new Color (255,255,255,0.355f), (float)i/5);
            yield return new WaitForSeconds(0.05f);
        }    
        brains.image[1].color =  new Color (255,255,255,0.355f);     
    }
